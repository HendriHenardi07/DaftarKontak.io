          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Management Operator</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <button type="button" class="btn btn-default bg-primary" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                  $no = 0;
                    $query = mysqli_query($koneksi,"SELECT * FROM tb_user WHERE level='Operator'");
                  ...
                  <tr>
                    ...
                    <td width=22%>
                  <a onclick="hapus_data()" href="admin/hapus-operator.php?id=<?php echo $dft['id'];?>" 
                  class="btn btn-default bg-danger">Hapus</a>
                  <a class="view-data-operator btn btn-info" data-toggle="modal" data-target="#modal-view" 
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="get" action="admin/add-operator.php">
